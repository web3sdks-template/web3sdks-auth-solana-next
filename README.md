...
This example demonstrates how to use web3sdks Auth for Solana wallets with NextJS.
...
Next, you need to create a `.env.local` file and add the `WEB3SDKS_AUTH_PRIVATE_KEY` variable to it with the private key of the wallet you want to use as the admin wallet to generate and verify payloads. Your file should use something like the following:

```.env.local
WEB3SDKS_AUTH_PRIVATE_KEY=...
```
...
- [web3sdks Solana Documentation](https://docs.web3sdks.com/solana) - learn about web3sdks Solana.
